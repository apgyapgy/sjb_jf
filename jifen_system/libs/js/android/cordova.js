(function() {
    ...
    define("cordova/plugin/Acceleration",
        function(require, exports, module) {
    ...
    define("cordova/plugin/CameraPopoverHandle",
        function(require, exports, module) {
            var exec = require("cordova/exec");
    ...
    define("cordova/plugin/CameraPopoverOptions",
        function(require, exports, module) {
    ...
    define("cordova/plugin/CaptureAudioOptions",
        function(require, exports, module) {
    ...
    define("cordova/plugin/CaptureError",
        function(require, exports, module) {
    ...
    define("cordova/plugin/CaptureImageOptions",
        function(require, exports, module) {
    ...
    define("cordova/plugin/CaptureVideoOptions",
        function(require, exports, module) {
    ...
    define("cordova/plugin/CompassError",
        function(require, exports, module) {
    ...
    define("cordova/plugin/CompassHeading",
        function(require, exports, module) {
    ...
    define("cordova/plugin/ConfigurationData",
        function(require, exports, module) {
    ...
    define("cordova/plugin/Connection",
        function(require, exports, module) {
            module.exports = {
                UNKNOWN: "unknown",
                ETHERNET: "ethernet",
    ...
    define("cordova/plugin/ContactAddress",
        function(require, exports, module) {
    ...
    define("cordova/plugin/ContactError",
        function(require, exports, module) {
    ...
    define("cordova/plugin/ContactField",
        function(require, exports, module) {
    ...
    define("cordova/plugin/ContactName",
        function(require, exports, module) {
    ...
    define("cordova/plugin/ContactOrganization",
        function(require, exports, module) {
    ...
    define("cordova/plugin/Coordinates",
        function(require, exports, module) {
    ...
    define("cordova/plugin/DirectoryEntry",
        function(require, exports, module) {
            var argscheck = require("cordova/argscheck"),
                utils = require("cordova/utils"),
                exec = require("cordova/exec"),
    ...
    define("cordova/plugin/DirectoryReader",
        function(require, exports, module) {
            var exec = require("cordova/exec"),
                FileError = require("cordova/plugin/FileError");
    ...
    define("cordova/plugin/FileEntry",
        function(require, exports, module) {
            var utils = require("cordova/utils"),
                exec = require("cordova/exec"),
                Entry = require("cordova/plugin/Entry"),
    ...
    define("cordova/plugin/FileError",
        function(require, exports, module) {
    ...
    define("cordova/plugin/FileReader",
        function(require, exports, module) {
            var exec = require("cordova/exec"),
                modulemapper = require("cordova/modulemapper"),
                utils = require("cordova/utils"),
            ...
            utils.defineGetter(FileReader.prototype, "error",
                function() {
                    return this._fileName ? this._error: this._realReader.error
                });
            utils.defineGetter(FileReader.prototype, "result",
                function() {
    ...
    define("cordova/plugin/FileSystem",
        function(require, exports, module) {
            var DirectoryEntry = require("cordova/plugin/DirectoryEntry");
    ...
    define("cordova/plugin/FileTransfer",
        function(require, exports, module) {
            var argscheck = require("cordova/argscheck"),
                exec = require("cordova/exec"),
    ...
    define("cordova/plugin/FileTransferError",
        function(require, exports, module) {
    ...
    define("cordova/plugin/FileUploadOptions",
        function(require, exports, module) {
    ...
    define("cordova/plugin/FileWriter",
        function(require, exports, module) {
            var exec = require("cordova/exec"),
                FileError = require("cordova/plugin/FileError"),
                ProgressEvent = require("cordova/plugin/ProgressEvent");
    ...
    define("cordova/plugin/GlobalizationError",
        function(require, exports, module) {
    ...
    define("cordova/plugin/InAppBrowser",
        function(require, exports, module) {
            var exec = require("cordova/exec");
            var channel = require("cordova/channel");
    ...
    define("cordova/plugin/MediaError",
        function(require, exports, module) {
    ...
    define("cordova/plugin/MediaFile",
        function(require, exports, module) {
            var utils = require("cordova/utils"),
                exec = require("cordova/exec"),
                File = require("cordova/plugin/File"),
    ...
    define("cordova/plugin/MediaFileData",
        function(require, exports, module) {
    ...
    define("cordova/plugin/Metadata",
        function(require, exports, module) {
    ...
    define("cordova/plugin/PositionError",
        function(require, exports, module) {
    ...
    define("cordova/plugin/ProgressEvent",
        function(require, exports, module) {
    ...
    define("cordova/plugin/accelerometer",
        function(require, exports, module) {
            var argscheck = require("cordova/argscheck"),
                utils = require("cordova/utils"),
                exec = require("cordova/exec"),
    ...
    define("cordova/plugin/accelerometer/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper");
    ...
    define("cordova/plugin/android/app",
        function(require, exports, module) {
            var exec = require("cordova/exec");
            module.exports = {
                clearCache: function() {
    ...
    define("cordova/plugin/android/device",
        function(require, exports, module) {
            var channel = require("cordova/channel"),
                utils = require("cordova/utils"),
                exec = require("cordova/exec"),
    ...
    define("cordova/plugin/android/nativeapiprovider",
        function(require, exports, module) {
    ...
    define("cordova/plugin/android/notification",
        function(require, exports, module) {
            var exec = require("cordova/exec");
            module.exports = {
    ...
    define("cordova/plugin/android/promptbasednativeapi",
        function(require, exports, module) {
            module.exports = {
    ...
    define("cordova/plugin/android/storage",
        function(require, exports, module) {
            var utils = require("cordova/utils"),
                exec = require("cordova/exec"),
    ...
    define("cordova/plugin/android/storage/openDatabase",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper"),
    ...
    define("cordova/plugin/camera/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper");
    ...
    define("cordova/plugin/console-via-logger",
        function(require, exports, module) {
    ...
    define("cordova/plugin/contacts",
        function(require, exports, module) {
            var argscheck = require("cordova/argscheck"),
                exec = require("cordova/exec"),
                ContactError = require("cordova/plugin/ContactError"),
    ...
    define("cordova/plugin/file/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper"),
                symbolshelper = require("cordova/plugin/file/symbolshelper");
            symbolshelper(modulemapper.clobbers)
        });
    define("cordova/plugin/file/symbolshelper",
        function(require, exports, module) {
    ...
    define("cordova/plugin/filetransfer/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper");
    ...
    define("cordova/plugin/geolocation",
        function(require, exports, module) {
            var argscheck = require("cordova/argscheck"),
                utils = require("cordova/utils"),
                exec = require("cordova/exec"),
    ...
    define("cordova/plugin/geolocation/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper");
    ...
    define("cordova/plugin/globalization",
        function(require, exports, module) {
            var argscheck = require("cordova/argscheck"),
                exec = require("cordova/exec"),
    ...
    define("cordova/plugin/globalization/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper");
    ...
    define("cordova/plugin/inappbrowser/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper");
            modulemapper.clobbers("cordova/plugin/InAppBrowser", "open")
        });
    define("cordova/plugin/logger",
        function(require, exports, module) {
            var logger = exports;
            var exec = require("cordova/exec");
            var utils = require("cordova/utils");
    ...
    define("cordova/plugin/network",
        function(require, exports, module) {
            ...
            if (typeof navigator != "undefined") {
                utils.defineGetter(navigator, "onLine",
                    function() {
    ...
    define("cordova/plugin/networkstatus/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper");
    ...
    define("cordova/plugin/notification/symbols",
        function(require, exports, module) {
            var modulemapper = require("cordova/modulemapper");
    ...
    define("cordova/plugin/requestFileSystem",
        function(require, exports, module) {
            var argscheck = require("cordova/argscheck"),
                FileError = require("cordova/plugin/FileError"),
    ...
    define("cordova/plugin/resolveLocalFileSystemURI",
        function(require, exports, module) {
            var argscheck = require("cordova/argscheck"),
    ...
    define("cordova/plugin/splashscreen",
        function(require, exports, module) {
            var exec = require("cordova/exec");
            var splashscreen = {
                show: function() {
    ...
    (function(context) {
        ...
        // 10秒之后deviceready事件还没有被调用将输出log提示
    ...
    require("cordova/channel").onNativeReady.fire(); (function(context) {
        ...
        try {
            xhr.open("POST", plugins_json, true);
            xhr.send()
        } catch(err) {
            injectPluginScript()
        }
